...
BEGIN
  SELECT USER, SYSDATE INTO VUSUARIO, VFECHA FROM DUAL;
    IF INSERTING THEN
      VACCION := 'SE AGREGÓ UNA BICICLETA NUEVA';
    ELSIF UPDATING THEN
      VACCION := 'SE ACTUALIZÓ UNA BICICLETA';
    ELSIF DELETING THEN
      VACCION := 'SE ELIMINÓ UNA BICICLETA';
    END IF;
...
>>>>>>> Stashed changes
BEGIN
  SELECT ID_FACTURA INTO VID_FACTURA FROM FACTURA;
  SELECT NOMBRE INTO VNOMBRE FROM FACTURA;
  SELECT APELLIDO INTO VAPELLIDO FROM FACTURA;
  SELECT USUARIO INTO VUSUARIO FROM FACTURA;
  SELECT CEDULA INTO VIDENTIFICACION FROM FACTURA;
  SELECT TERMINOS INTO VTERMINOS FROM FACTURA;
  SELECT FECHA INTO VFECHA FROM FACTURA;
  
      INSERT INTO HISTORICO_FACTURA (ID_FACTURA, NOMBRE,APELLIDO,USUARIO,IDENTIFICACION,TERMINOS,FECHA)
      VALUES (VID_FACTURA, VNOMBRE, VAPELLIDO,VUSUARIO,VIDENTIFICACION,VTERMINOS,VFECHA);
END;
...
BEGIN
  SELECT DESCRIPCION INTO VDESCRIPCION FROM DETALLEFACTURA;
  SELECT CANTIDAD INTO VCANTIDAD FROM DETALLEFACTURA;
  SELECT PRECIO INTO VPRECIO FROM DETALLEFACTURA;
  SELECT MONTO INTO VMONTO FROM DETALLEFACTURA;
  SELECT ID_FACTURA INTO VID_FACTURA FROM DETALLEFACTURA;
