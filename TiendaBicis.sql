...
ID_tarjeta NUMBER (38) NOT NULL,
CONSTRAINT PK_Usuarios PRIMARY KEY(ID_tarjeta),
...
/* Hay que modificar esta tabla entonces no la creé*/
...
CONSTRAINT FK_UsuarioFactura FOREIGN KEY (ID_Usuario) REFERENCES Usuario(ID_Usuario),
